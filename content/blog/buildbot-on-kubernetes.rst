...
.. include:: content/blog/.code/buildbot-on-k8s/initial-buildbot.yaml
    :code: yaml
...
.. image:: /static/buildbot-on-k8s/wordpress-working.png
...
.. include:: content/blog/.code/buildbot-on-k8s/initial-master.yaml
    :code: yaml

``postgres.yaml:``

.. include:: content/blog/.code/buildbot-on-k8s/initial-postgres.yaml
    :code: yaml
...
.. image:: /static/buildbot-on-k8s/buildbot-working.png
...
.. include:: content/blog/.code/buildbot-on-k8s/initial-worker.yaml
    :code: yaml
...
.. include:: content/blog/.code/buildbot-on-k8s/updated-master.yaml.diff
    :code: diff
...
.. image:: /static/buildbot-on-k8s/build-success.png
...
.. image:: /static/buildbot-on-k8s/happy-dance.gif
    :alt: Happy Dance .gif
    :align: center
    :width: 100%
...
.. include:: content/blog/.code/buildbot-on-k8s/volumes.yaml
    :code: yaml

``master.yaml``:

.. include:: content/blog/.code/buildbot-on-k8s/volumes-master.yaml.diff
    :code: diff

``postgres.yaml``:

.. include:: content/blog/.code/buildbot-on-k8s/volumes-postgres.yaml.diff
    :code: diff

``worker.yaml``:

.. include:: content/blog/.code/buildbot-on-k8s/volumes-worker.yaml.diff
    :code: diff

And of lastly we edit the Buildbot ``master.cfg`` to use our custom paths for storing and carrying out builds:

.. include:: content/blog/.code/buildbot-on-k8s/volumes-master.cfg.diff
    :code: diff
...
.. image:: /static/buildbot-on-k8s/build-success-perms.png
...
.. include:: content/blog/.code/buildbot-on-k8s/Dockerfile
    :code:
...
.. include:: content/blog/.code/buildbot-on-k8s/robust-master.cfg.diff
    :code: diff

And deploy it with this ``master.yaml``:

.. include:: content/blog/.code/buildbot-on-k8s/robust-master.yaml.diff
    :code: diff

When we look at our setup in Buildbot it looks like this:

.. image:: /static/buildbot-on-k8s/ample-workload.png
...
.. image:: /static/buildbot-on-k8s/hello-heapster.png
...
.. include:: content/blog/.code/buildbot-on-k8s/robust-worker.yaml.diff
    :code: diff
...
.. image:: /static/buildbot-on-k8s/replicas-didnt-work.png
...
.. image:: /static/buildbot-on-k8s/failed-build.png
...
.. image:: /static/buildbot-on-k8s/sucking-quote.jpg
